                ...
                <div className="mt4" id="personal">
                    ...
                    <div className="half-width">
                        ...
                        <div className="flex flex-wrap w-100">
                            <TextField
                                ...
                                onKeyPress={(e) => {
                                    ...
                                    if (e.key === 'Enter') {
                                        event.preventDefault();
                                        if (
                                            languages.includes(languagesInput)
                                        ) {
                                            setAlert(
                                                'Ya agregaste este idioma'
                                            );
                                            return;
                                        }
                                        setLanguages((prev) =>
                                            prev.concat(languagesInput)
                                        );
                                        setLanguagesInput('');
                                        return;
                                    }
                            ...
                            />
                            <Stack
                                className="overflow-x-auto mw-100 pt2"
                                direction="row"
                                spacing={1}
                            >
                                {languages.length > 0 &&
                                ...
                                onKeyPress={(e) => {
                                    ...
                                    if (e.key === 'Enter') {
                                        ...
                                        if (skills.includes(skillsInput)) {
                                            setAlert(
                                                'Ya agregaste esta habilidad'
                                            );
                                            return;
                                        }
                                        setSkills((prev) =>
                                            prev.concat(skillsInput)
                                        );
                                        setSkillsInput('');
                                        return;
                                    }
